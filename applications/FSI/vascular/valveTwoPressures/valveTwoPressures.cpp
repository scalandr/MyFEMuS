...
//   // ******* Initialize solution *******
  ...
  const unsigned int n_timesteps = 128; //320=5 seconds with dt=1./64, 128=4 s with dt=1./32
...
//   }
  ...
  if(iproc == 0){
    ...
    sprintf(stdOutputName, "stdoutput_level%d_nprocs%d_stiffness5_dt1su32.txt",numberOfUniformRefinedMeshes, nprocs);
